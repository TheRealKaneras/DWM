...
public abstract class DWMTree {

    /**
     * Get a {@link net.minecraft.world.gen.feature.ConfiguredFeature} of tree
     */
    @Nullable
    protected abstract ConfiguredFeature<BasicTreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean p_225546_2_);
    ...
    public boolean func_225545_a_(IWorld p_225545_1_, ChunkGenerator<?> p_225545_2_, BlockPos p_225545_3_, BlockState p_225545_4_, Random p_225545_5_) {
        ConfiguredFeature<BasicTreeFeatureConfig, ?> configuredfeature = this.getTreeFeature(p_225545_5_, this.func_230140_a_(p_225545_1_, p_225545_3_));
