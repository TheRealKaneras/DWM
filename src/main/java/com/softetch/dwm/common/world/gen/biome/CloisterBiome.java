...
public class CloisterBiome extends Biome {
    public CloisterBiome() {
        super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.SWAMP, ModSurfaceBuilder.GALLIFREY_GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).depth(-0.2F).scale(0.1F).temperature(0.8F).downfall(0.9F).waterColor(6388580).waterFogColor(2302743).parent((String)null));
...
//        DefaultBiomeFeatures.addStructures(this);
        ...
        GallifreyBiomeFeatures.addSoulTree(this, 2, 0.1f, 1);
