...
public class GallifreyChunkGenerator extends NoiseChunkGenerator<GallifreyGenSettings> {
    ...
    public GallifreyChunkGenerator(IWorld worldIn, BiomeProvider provider, GallifreyGenSettings settingsIn) {
