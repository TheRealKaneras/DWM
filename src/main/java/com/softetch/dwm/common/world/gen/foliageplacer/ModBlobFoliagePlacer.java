...
public class ModBlobFoliagePlacer extends ModFoliagePlacer {
    public ModBlobFoliagePlacer(int p_i225846_1_, int p_i225846_2_) {
        super(p_i225846_1_, p_i225846_2_, FoliagePlacerType.field_227386_a_);
    }

    public <T> ModBlobFoliagePlacer(Dynamic<T> p_i225847_1_) {
