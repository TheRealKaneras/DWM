...
public class BrachackiBoxDModel extends AbstractTardisExteriorModel {
	...
	public BrachackiBoxDModel() {
		...
		rightDoor.cubeList.add(new ModelBox(rightDoor, 379, 77, 1.0F, -23.0F, -0.95F, 6, 6, 1, 0.0F, false));
		...
		leftDoor.cubeList.add(new ModelBox(leftDoor, 100, 357, -6.25F, -17.25F, -1.2F, 1, 1, 1, 0.0F, false));
