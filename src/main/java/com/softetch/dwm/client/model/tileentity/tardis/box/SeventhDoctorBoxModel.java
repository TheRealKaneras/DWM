...
public class SeventhDoctorBoxModel extends AbstractTardisExteriorModel {
	...
	public SeventhDoctorBoxModel() {
		...
		Main.setTextureOffset(0, 0).addBox(-2.5F, -8.35F, -0.9F, 13.0F, 2.0F, 1.0F, 0.0F, false);
		Main.setTextureOffset(0, 0).addBox(-1.5F, -6.25F, -1.1F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		Main.setTextureOffset(0, 0).addBox(-1.5F, -5.95F, -1.0F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		Main.setTextureOffset(0, 0).addBox(-1.5F, -5.55F, -0.9F, 11.0F, 1.0F, 1.0F, 0.0F, false);

		Door1 = new ModelRenderer(this);
		Door1.setRotationPoint(9.0F, 7.1F, -0.3F);
		Main.addChild(Door1);
		Door1.setTextureOffset(0, 0).addBox(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(3, 12).addBox(-5.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(7, 6).addBox(-5.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 10).addBox(-0.7F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(20, 7).addBox(-0.7F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 8).addBox(-5.0F, 3.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 10).addBox(-5.0F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(11, 8).addBox(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, true);
		Door1.setTextureOffset(6, 6).addBox(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 0).addBox(-4.0F, -6.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 8).addBox(-5.0F, -6.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 8).addBox(-0.7F, -6.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 5).addBox(-5.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 0).addBox(-0.7F, -11.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(0, 0).addBox(-5.0F, -11.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door1.setTextureOffset(20, 0).addBox(-5.0F, -12.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bone18.setTextureOffset(11, 14).addBox(0.7964F, -3.3876F, -0.94F, 1.0F, 1.0F, 1.0F, -0.2F, false);

		bone40 = new ModelRenderer(this);
		bone40.setRotationPoint(-4.8786F, -3.6876F, 0.485F);
		Door1.addChild(bone40);
		setRotationAngle(bone40, 0.0F, 0.7854F, 0.0F);
		bone40.setTextureOffset(6, 26).addBox(-0.0581F, 0.0876F, -0.3409F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		Door2 = new ModelRenderer(this);
		Door2.setRotationPoint(-1.0F, 7.1F, -0.3F);
		Main.addChild(Door2);
		Door2.setTextureOffset(0, 5).addBox(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(10, 27).addBox(0.1F, -6.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 8).addBox(-0.3F, -6.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 8).addBox(4.0F, -6.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(4.0F, -11.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(20, 0).addBox(0.0F, -12.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(-0.3F, -11.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(22, 15).addBox(-0.075F, -11.1F, -0.08F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(8, 7).addBox(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 12).addBox(0.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(5, 10).addBox(4.0F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(5, 8).addBox(4.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 13).addBox(0.0F, 3.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(2, 12).addBox(0.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(7, 15).addBox(0.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 10).addBox(-0.3F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(2, 7).addBox(-0.3F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(-0.35F, -2.4F, -0.2F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(0.05F, -6.3F, -0.2F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(1.05F, -6.7F, -0.2F, 3.0F, 1.0F, 1.0F, 0.0F, false);
		Door2.setTextureOffset(0, 0).addBox(3.65F, -5.7F, -0.2F, 1.0F, 4.0F, 1.0F, 0.0F, false);

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(5.25F, -2.1F, 0.7F);
		Door2.addChild(bone3);
		setRotationAngle(bone3, 0.0F, -0.7854F, 0.0F);
		bone3.setTextureOffset(19, 0).addBox(-1.1036F, -9.9F, -0.8536F, 1.0F, 21.0F, 1.0F, 0.0F, false);
		...
		Window1_2.setTextureOffset(0, 25).addBox(-0.3F, 3.3766F, -4.26F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		Window1_2.setTextureOffset(22, 20).addBox(-0.3F, -2.952F, 2.0686F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		Window1_2.setTextureOffset(0, 25).addBox(-0.3F, 0.5482F, -1.4315F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		...
		window2_2.setTextureOffset(0, 25).addBox(-4.3891F, 2.6F, 2.9648F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		...
		window2_2.setTextureOffset(0, 25).addBox(-6.7225F, 2.6F, 5.2983F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		...
		bone19.setTextureOffset(6, 29).addBox(0.0834F, -0.1124F, -0.1995F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		bone16 = new ModelRenderer(this);
		bone16.setRotationPoint(4.0F, -7.7F, -0.9F);
		Main.addChild(bone16);
		setRotationAngle(bone16, 0.3491F, 0.0F, 0.0F);
		bone16.setTextureOffset(0, 0).addBox(-6.0F, 0.3055F, -0.936F, 12.0F, 1.0F, 1.0F, 0.0F, false);

		bone17 = new ModelRenderer(this);
		bone17.setRotationPoint(4.0F, -7.3F, -0.9F);
		Main.addChild(bone17);
		setRotationAngle(bone17, -0.3491F, 0.0F, 0.0F);
		bone17.setTextureOffset(0, 0).addBox(-6.0F, 0.7618F, -0.1835F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		...
		post.setTextureOffset(19, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-1.4F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		...
		post.setTextureOffset(19, 0).addBox(-1.4F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-0.6F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-0.6F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		...
		post2.setTextureOffset(19, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post2.setTextureOffset(19, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post2.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post2.setTextureOffset(19, 0).addBox(-1.4F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		...
		post2.setTextureOffset(19, 0).addBox(-0.6F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		...
		post3.setTextureOffset(19, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		...
		post3.setTextureOffset(19, 0).addBox(-1.4F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post3.setTextureOffset(19, 0).addBox(-0.6F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post3.setTextureOffset(19, 0).addBox(-0.6F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post3.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		...
		post4.setTextureOffset(19, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-1.4F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-1.4F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-0.6F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-0.6F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, 0.0F, false);
		post4.setTextureOffset(19, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, 0.0F, false);
		...
		Main2.setTextureOffset(11, 8).addBox(1.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main2.setTextureOffset(11, 8).addBox(-5.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		...
		Main2.setTextureOffset(0, 0).addBox(-6.5F, -25.45F, -6.6F, 13.0F, 2.0F, 1.0F, 0.0F, false);
		Main2.setTextureOffset(0, 0).addBox(-5.5F, -23.35F, -6.8F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		Main2.setTextureOffset(0, 0).addBox(-5.5F, -23.05F, -6.7F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		Main2.setTextureOffset(0, 0).addBox(-5.5F, -22.65F, -6.6F, 11.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bone22.setTextureOffset(0, 0).addBox(-6.0F, 0.3055F, -0.936F, 12.0F, 1.0F, 1.0F, 0.0F, false);

		bone23 = new ModelRenderer(this);
		bone23.setRotationPoint(0.0F, -24.4F, -6.6F);
		Main2.addChild(bone23);
		setRotationAngle(bone23, -0.3491F, 0.0F, 0.0F);
		bone23.setTextureOffset(0, 0).addBox(-6.0F, 0.7618F, -0.1835F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		...
		Main3.setTextureOffset(11, 8).addBox(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main3.setTextureOffset(10, 0).addBox(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, 0.0F, false);
		Main3.setTextureOffset(0, 12).addBox(-5.0F, -12.0F, -6.3F, 10.0F, 1.0F, 1.0F, 0.0F, false);
		...
		Main3.setTextureOffset(6, 20).addBox(-6.0F, -24.0F, -7.3F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		...
		Main3.setTextureOffset(12, 13).addBox(4.3F, -6.0F, -6.3F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		...
		bone27.setTextureOffset(19, 0).addBox(-0.9621F, -10.9F, -0.7121F, 1.0F, 22.0F, 1.0F, 0.0F, false);
		...
		Main4.setTextureOffset(11, 8).addBox(1.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main4.setTextureOffset(20, 10).addBox(-5.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main4.setTextureOffset(8, 15).addBox(-5.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main4.setTextureOffset(11, 8).addBox(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);
		Main4.setTextureOffset(0, 23).addBox(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, 0.0F, false);
		...
		Main4.setTextureOffset(6, 20).addBox(-6.0F, -24.0F, -7.3F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		...
		bone41.setTextureOffset(0, 0).addBox(7.0F, 26.1F, -13.0F, 7.0F, 1.0F, 15.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(-1.0F, 26.1F, -13.0F, 8.0F, 1.0F, 15.0F, 0.0F, true);
		bone41.setTextureOffset(0, 0).addBox(0.5F, 0.7F, -11.5F, 12.0F, 3.0F, 12.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(1.0F, 0.6F, -11.0F, 11.0F, 3.0F, 11.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(1.5F, 0.5F, -10.5F, 10.0F, 3.0F, 10.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(2.0F, 0.4F, -10.0F, 9.0F, 3.0F, 9.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(2.5F, 0.3F, -9.5F, 8.0F, 3.0F, 8.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(3.0F, 0.2F, -9.0F, 7.0F, 3.0F, 7.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(3.5F, 0.1F, -8.5F, 6.0F, 3.0F, 6.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(4.0F, 0.0F, -8.0F, 5.0F, 3.0F, 5.0F, 0.0F, false);
		bone41.setTextureOffset(0, 0).addBox(4.5F, -0.3F, -7.5F, 4.0F, 3.0F, 4.0F, 0.0F, false);

		bone42 = new ModelRenderer(this);
		bone42.setRotationPoint(6.5F, -0.5333F, -5.5F);
		bone41.addChild(bone42);
		setRotationAngle(bone42, 0.0F, 0.7854F, 0.0F);
		bone42.setTextureOffset(24, 28).addBox(-1.0F, -1.6167F, -1.0F, 2.0F, 2.0F, 2.0F, 0.225F, false);

		bone43 = new ModelRenderer(this);
		bone43.setRotationPoint(0.0F, 0.1083F, 0.0F);
		bone42.addChild(bone43);
		setRotationAngle(bone43, 0.0F, 0.7854F, 0.0F);
		bone43.setTextureOffset(28, 26).addBox(-0.5F, -1.85F, -0.5F, 1.0F, 1.0F, 1.0F, 0.2F, false);
		bone43.setTextureOffset(20, 29).addBox(-0.5F, -0.45F, -0.5F, 1.0F, 2.0F, 1.0F, 0.2F, false);
	}
