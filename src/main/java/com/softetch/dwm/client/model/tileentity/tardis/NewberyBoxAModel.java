...
public class NewberyBoxAModel extends AbstractTardisExteriorModel {
	...
	public NewberyBoxAModel() {
		...
		lamp.setTextureOffset(269, 123).addBox(-1.0F, -42.75F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		lamp.setTextureOffset(269, 123).addBox(0.0F, -43.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lamp.setTextureOffset(269, 123).addBox(-1.0F, -43.0F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lamp.setTextureOffset(269, 123).addBox(-0.5F, -43.0F, -1.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		lamp.setTextureOffset(269, 123).addBox(-0.5F, -43.0F, 0.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
