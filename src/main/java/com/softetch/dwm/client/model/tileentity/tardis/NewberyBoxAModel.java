...
public class NewberyBoxAModel extends AbstractTardisExteriorModel {
	...
	private final RendererModel windowsDOORLEFT;
	...
	private final RendererModel windowsDOORLEFT2;
	...
	public NewberyBoxAModel() {
		textureWidth = 512;
		textureHeight = 512;

		lamp = new RendererModel(this);
		lamp.setRotationPoint(0.0F, 24.0F, 0.0F);
		lamp.cubeList.add(new ModelBox(lamp, 269, 123, -1.0F, -42.75F, -1.0F, 2, 3, 2, 0.0F, false));
		lamp.cubeList.add(new ModelBox(lamp, 269, 123, 0.0F, -43.0F, -0.5F, 1, 3, 1, 0.0F, false));
		lamp.cubeList.add(new ModelBox(lamp, 269, 123, -1.0F, -43.0F, -0.5F, 1, 3, 1, 0.0F, false));
		lamp.cubeList.add(new ModelBox(lamp, 269, 123, -0.5F, -43.0F, -1.0F, 1, 3, 1, 0.0F, false));
		lamp.cubeList.add(new ModelBox(lamp, 269, 123, -0.5F, -43.0F, 0.0F, 1, 3, 1, 0.0F, false));
		...
		box.cubeList.add(new ModelBox(box, 205, 489, -8.0F, -32.0F, 7.75F, 16, 8, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 205, 489, 7.75F, -32.0F, -8.0F, 1, 8, 16, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 205, 489, -8.75F, -32.0F, -8.0F, 1, 8, 16, 0.0F, true));
		...
		box.cubeList.add(new ModelBox(box, 441, 0, -9.0F, -38.5F, -9.0F, 18, 2, 18, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -7.0F, -38.7F, -7.0F, 14, 2, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -5.0F, -38.9F, -5.0F, 10, 2, 10, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -8.0F, -38.6F, -8.0F, 16, 2, 16, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -6.0F, -38.8F, -6.0F, 12, 2, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -4.0F, -39.0F, -4.0F, 8, 2, 8, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -3.0F, -39.1F, -3.0F, 6, 2, 6, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 441, 0, -2.0F, -39.6F, -2.0F, 4, 2, 4, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -8.5F, -38.55F, -8.5F, 17, 2, 17, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -6.5F, -38.75F, -6.5F, 13, 2, 13, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -4.5F, -38.95F, -4.5F, 9, 2, 9, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -7.5F, -38.65F, -7.5F, 15, 2, 15, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -5.5F, -38.85F, -5.5F, 11, 2, 11, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -3.5F, -39.05F, -3.5F, 7, 2, 7, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 48, 231, -2.5F, -39.15F, -2.5F, 5, 2, 5, 0.0F, false));
		...
		box.cubeList.add(new ModelBox(box, 503, 0, 9.5F, -32.5F, -9.5F, 3, 0, 19, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 503, 0, -12.5F, -32.5F, -9.5F, 4, 0, 19, 0.0F, true));
		...
		box.cubeList.add(new ModelBox(box, 503, 0, 9.5F, -34.5F, -9.5F, 3, 0, 19, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 503, 0, -12.5F, -34.5F, -9.5F, 4, 0, 19, 0.0F, true));
		...
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 0.0F, -1.5F, -1.0F, 8, 2, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 0.0F, -9.0F, -1.0F, 8, 1, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 6.5F, -31.5F, -1.0F, 2, 32, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 509, 480, 7.5F, -31.5F, -1.5F, 1, 32, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 479, 489, 0.0F, -16.0F, -0.75F, 8, 16, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 160, 505, 0.0F, -23.0F, -0.75F, 8, 7, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 0.0F, -24.0F, -1.0F, 8, 1, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 0.0F, -31.5F, -1.0F, 8, 1, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 205, 489, 0.0F, -31.0F, -0.75F, 8, 8, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, -0.5F, -31.0F, -1.0F, 2, 31, 1, 0.0F, false));
		rightDoor.cubeList.add(new ModelBox(rightDoor, 0, 0, 0.0F, -16.5F, -1.0F, 8, 1, 1, 0.0F, false));

		windowsDOORLEFT = new RendererModel(this);
		...
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.0F, -1.5F, -1.0F, 8, 2, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.0F, -9.0F, -1.0F, 8, 1, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.5F, -31.0F, -1.0F, 2, 31, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 479, 489, -8.0F, -23.0F, -0.75F, 8, 23, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.0F, -24.0F, -1.0F, 8, 1, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.5F, -31.5F, -1.0F, 9, 1, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 205, 489, -8.0F, -31.0F, -0.75F, 8, 8, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -1.5F, -31.0F, -1.0F, 2, 31, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 0, 0, -8.0F, -16.5F, -1.0F, 8, 1, 1, 0.0F, true));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 174, 21, -7.0F, -22.0F, -1.5F, 0, 3, 1, 0.0F, false));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 174, 21, -7.5F, -16.5F, -1.5F, 1, 1, 1, 0.0F, false));

		windowsDOORLEFT2 = new RendererModel(this);
