...
public class NewberyBoxCModel extends AbstractTardisExteriorModel {
	...
	private final ModelRenderer doorRightWindows;
	...
	private final ModelRenderer doorLeftWindows;
	...
	public NewberyBoxCModel() {
		...
		lamp.setTextureOffset(221, 508).addBox(-1.0F, -43.5F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		lamp.setTextureOffset(221, 508).addBox(-0.75F, -43.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		lamp.setTextureOffset(221, 508).addBox(-1.25F, -43.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		lamp.setTextureOffset(221, 508).addBox(-1.0F, -43.0F, -0.75F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		lamp.setTextureOffset(221, 508).addBox(-1.0F, -43.0F, -1.25F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		...
		box.setTextureOffset(205, 489).addBox(-8.0F, -32.0F, 7.65F, 16.0F, 8.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(205, 489).addBox(7.65F, -32.0F, -8.0F, 1.0F, 8.0F, 16.0F, 0.0F, false);
		box.setTextureOffset(205, 489).addBox(-8.65F, -32.0F, -8.0F, 1.0F, 8.0F, 16.0F, 0.0F, true);
		...
		box.setTextureOffset(388, 0).addBox(-9.0F, -38.5F, -9.0F, 18.0F, 2.0F, 18.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-7.0F, -39.7F, -7.0F, 14.0F, 2.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-5.0F, -39.9F, -5.0F, 10.0F, 2.0F, 10.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-6.0F, -39.8F, -6.0F, 12.0F, 2.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-4.0F, -40.0F, -4.0F, 8.0F, 2.0F, 8.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-3.0F, -40.1F, -3.0F, 6.0F, 2.0F, 6.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-2.0F, -41.5F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-1.5F, -44.5F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-0.5F, -43.5F, 0.9F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(-1.9F, -43.5F, -1.9F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(441, 0).addBox(0.9F, -43.5F, -1.9F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-6.5F, -39.75F, -6.5F, 13.0F, 2.0F, 13.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-4.5F, -39.95F, -4.5F, 9.0F, 2.0F, 9.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-7.5F, -39.65F, -7.5F, 15.0F, 2.0F, 15.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-5.5F, -39.85F, -5.5F, 11.0F, 2.0F, 11.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-3.5F, -40.05F, -3.5F, 7.0F, 2.0F, 7.0F, 0.0F, false);
		box.setTextureOffset(48, 231).addBox(-2.5F, -40.15F, -2.5F, 5.0F, 2.0F, 5.0F, 0.0F, false);
		...
		box.setTextureOffset(469, 0).addBox(9.5F, -32.5F, -9.5F, 3.0F, 0.0F, 19.0F, 0.0F, false);
		box.setTextureOffset(469, 0).addBox(8.5F, -32.5F, -9.5F, 3.0F, 0.0F, 19.0F, 0.0F, false);
		box.setTextureOffset(467, 0).addBox(-12.5F, -32.5F, -9.5F, 4.0F, 0.0F, 19.0F, 0.0F, true);
		...
		box.setTextureOffset(469, 1).addBox(9.5F, -34.5F, -9.5F, 3.0F, 0.0F, 19.0F, 0.0F, false);
		box.setTextureOffset(467, 0).addBox(-12.5F, -34.5F, -9.5F, 4.0F, 0.0F, 19.0F, 0.0F, true);
		...
		rightDoor.setTextureOffset(160, 505).addBox(0.0F, -23.0F, -0.6F, 8.0F, 7.0F, 1.0F, 0.0F, false);
		rightDoor.setTextureOffset(0, 0).addBox(0.0F, -24.0F, -1.0F, 8.0F, 1.0F, 1.0F, 0.0F, false);
		rightDoor.setTextureOffset(174, 21).addBox(6.25F, -21.0F, -1.0F, 0.0F, 2.0F, 1.0F, 0.0F, false);
		rightDoor.setTextureOffset(0, 0).addBox(0.0F, -31.5F, -1.0F, 8.0F, 1.0F, 1.0F, 0.0F, false);
		rightDoor.setTextureOffset(205, 489).addBox(0.0F, -31.0F, -0.65F, 8.0F, 8.0F, 1.0F, 0.0F, false);
		...
		doorRightWindows = new ModelRenderer(this);
		doorRightWindows.setRotationPoint(8.0F, -24.0F, -1.0F);
		rightDoor.addChild(doorRightWindows);
		setRotationAngle(doorRightWindows, 0.0F, 3.1416F, 0.0F);
		doorRightWindows.setTextureOffset(485, 496).addBox(1.0F, 0.5F, -1.25F, 1.0F, 8.0F, 1.0F, 0.0F, false);
		doorRightWindows.setTextureOffset(487, 511).addBox(6.0F, 0.5F, -1.25F, 1.0F, 8.0F, 1.0F, 0.0F, false);
		doorRightWindows.setTextureOffset(482, 504).addBox(1.0F, 7.0F, -1.25F, 6.0F, 1.0F, 1.0F, 0.0F, false);
		doorRightWindows.setTextureOffset(481, 501).addBox(1.0F, 0.5F, -1.25F, 6.0F, 1.0F, 1.0F, 0.0F, false);
		...
		leftDoor.setTextureOffset(205, 489).addBox(-8.0F, -31.0F, -0.65F, 8.0F, 8.0F, 1.0F, 0.0F, true);
		...
		doorLeftWindows = new ModelRenderer(this);
		doorLeftWindows.setRotationPoint(-8.0F, -24.0F, -1.0F);
		leftDoor.addChild(doorLeftWindows);
