...
public class SkaroDalekModel extends EntityModel<SkaroDalekEntity> {
	...
	public SkaroDalekModel() {
		...
		weaponsBelt.setTextureOffset(0, 0).addBox(-5.5F, -15.0F, -4.5F, 11.0F, 1.0F, 11.0F, 0.0F, false);
		weaponsBelt.setTextureOffset(64, 33).addBox(-5.0F, -14.0F, -4.0F, 10.0F, 2.0F, 10.0F, 0.0F, false);
		weaponsBelt.setTextureOffset(0, 0).addBox(-5.5F, -12.0F, -4.5F, 11.0F, 1.0F, 11.0F, 0.0F, false);

		neck = new ModelRenderer(this);
		neck.setRotationPoint(0.0F, 24.0F, 0.0F);
		neck.setTextureOffset(0, 0).addBox(0.75F, -19.5F, -3.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-1.75F, -19.5F, -3.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(3.25F, -19.5F, 2.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(3.25F, -19.5F, -0.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(3.25F, -19.0F, -3.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-1.75F, -19.5F, 4.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(0.75F, -19.5F, 4.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(3.25F, -19.0F, 4.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-4.25F, -19.0F, -3.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-4.25F, -19.5F, 2.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-4.25F, -19.5F, -0.5F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(38, 65).addBox(-3.5F, -18.5F, -2.5F, 7.0F, 3.0F, 7.0F, 0.0F, false);
		neck.setTextureOffset(92, 8).addBox(-4.5F, -19.5F, -3.5F, 9.0F, 1.0F, 9.0F, 0.0F, false);
		neck.setTextureOffset(92, 8).addBox(-4.5F, -17.5F, -3.5F, 9.0F, 1.0F, 9.0F, 0.0F, false);
		neck.setTextureOffset(0, 0).addBox(-4.25F, -19.0F, 4.25F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		neck.setTextureOffset(92, 8).addBox(-4.5F, -15.5F, -3.5F, 9.0F, 1.0F, 9.0F, 0.0F, false);
		...
		eyestalk.setTextureOffset(34, 98).addBox(-0.5F, -0.5F, -5.55F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		...
		skirt.setTextureOffset(102, 8).addBox(2.5F, -14.0F, -5.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		skirt.setTextureOffset(102, 8).addBox(-4.5F, -14.0F, -5.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setRotationAngles(SkaroDalekEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
