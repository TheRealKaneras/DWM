...
public class BrachackiBoxCModel extends AbstractTardisExteriorModel {
	...
	public BrachackiBoxCModel() {
		...
		lamp.cubeList.add(new ModelBox(lamp, 428, 260, 7.0F, -33.7F, -9.0F, 2, 4, 2, 0.0F, false));

		box = new RendererModel(this);
		box.setRotationPoint(0.0F, 24.0F, 0.0F);
		box.cubeList.add(new ModelBox(box, 332, 257, -9.5F, -1.0F, -9.5F, 19, 1, 19, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.5F, -38.0F, -8.5F, 17, 1, 17, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 148, 293, -7.5F, -37.1F, -7.5F, 15, 3, 15, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -7.0F, -38.15F, -7.0F, 14, 3, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -38.05F, -8.0F, 16, 1, 16, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -6.5F, -38.2F, -6.5F, 13, 3, 13, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -7.5F, -38.1F, -7.5F, 15, 1, 15, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -6.0F, -38.25F, -6.0F, 12, 3, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -5.5F, -38.3F, -5.5F, 11, 3, 11, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -5.0F, -38.35F, -5.0F, 10, 3, 10, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -4.5F, -38.4F, -4.5F, 9, 3, 9, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -4.0F, -38.45F, -4.0F, 8, 3, 8, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -3.5F, -38.5F, -3.5F, 7, 3, 7, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -2.5F, -38.6F, -2.5F, 5, 3, 5, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -3.0F, -38.55F, -3.0F, 6, 3, 6, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 99, 438, -1.5F, -38.9F, -1.5F, 3, 3, 3, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 379, 84, -1.0F, -42.2F, -1.0F, 2, 1, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 379, 84, 0.25F, -41.7F, -1.25F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 379, 84, 0.25F, -41.7F, 0.25F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 379, 84, -1.25F, -41.7F, -1.25F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 379, 84, -1.25F, -41.7F, 0.25F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 392, 59, -1.5F, -41.9F, -1.5F, 3, 1, 3, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -2.0F, -38.65F, -2.0F, 4, 3, 4, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 8.0F, -37.0F, -9.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 8.0F, -37.0F, 7.0F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -8.5F, -37.0F, -9.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 8.0F, -37.0F, -9.0F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 8.0F, -37.0F, 7.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -8.5F, -37.0F, 7.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, -9.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, 7.5F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, -9.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.0F, -37.0F, -9.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.5F, -37.0F, -9.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.5F, -37.0F, 7.5F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, -8.5F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, 8.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, 8.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.0F, -37.0F, 8.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.5F, -37.0F, -8.5F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.5F, -37.0F, 8.0F, 2, 36, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, -9.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, -9.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, 7.0F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, 7.5F, -37.0F, 7.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, -9.0F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 157, 100, -9.0F, -37.0F, 7.5F, 1, 36, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 6.0F, -33.0F, 7.0F, 1, 32, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -33.3F, -7.0F, 1, 32, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -33.3F, -7.0F, 1, 32, 1, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -4.0F, 7.0F, 12, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -4.3F, -6.0F, 1, 3, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 6, 7.25F, -4.0F, -7.0F, 1, 3, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -4.3F, -6.0F, 1, 3, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -11.0F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -11.3F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -11.3F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -11.5F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -11.8F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -11.8F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -18.0F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -18.3F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -18.3F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -18.5F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -18.8F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -18.8F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -25.0F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -25.3F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -25.3F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -25.5F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -25.8F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -25.8F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -33.0F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -33.3F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -33.3F, -6.0F, 1, 1, 12, 0.0F, true));
		...
		box.cubeList.add(new ModelBox(box, 345, 233, 1.0F, -33.7F, -8.45F, 1, 1, 0, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, -2.0F, -33.7F, -8.45F, 1, 1, 0, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, 7.45F, -34.3F, -7.0F, 1, 1, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, -8.45F, -34.3F, -7.0F, 1, 1, 14, 0.0F, true));
		...
		box.cubeList.add(new ModelBox(box, 0, 1, 7.65F, -34.6F, -7.0F, 1, 1, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.65F, -34.6F, -7.0F, 1, 1, 14, 0.0F, true));
		...
		box.cubeList.add(new ModelBox(box, 345, 233, 7.85F, -34.9F, -7.0F, 1, 1, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, -8.85F, -34.9F, -7.0F, 1, 1, 14, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -34.0F, 7.75F, 16, 0, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -34.0F, -9.75F, 16, 0, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, 7.75F, -34.3F, -8.0F, 2, 0, 16, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -9.75F, -34.3F, -8.0F, 2, 0, 16, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 321, 334, 6.0F, -36.0F, 7.75F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, 6.0F, -36.0F, -9.75F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, 7.75F, -36.3F, -8.0F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -9.75F, -36.3F, -8.0F, 2, 2, 2, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 145, 290, -6.0F, -36.0F, 8.95F, 12, 2, 0, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 145, 290, -6.0F, -36.0F, -9.2F, 12, 2, 0, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 44, 376, 9.2F, -36.3F, -6.0F, 0, 2, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 44, 376, -8.95F, -36.3F, -6.0F, 0, 2, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -36.0F, 7.75F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -36.0F, -9.75F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, 7.75F, -36.3F, 6.0F, 2, 2, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -9.75F, -36.3F, 6.0F, 2, 2, 2, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -36.0F, 7.75F, 16, 0, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -8.0F, -36.0F, -9.75F, 16, 0, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, 7.75F, -36.3F, -8.0F, 2, 0, 16, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 321, 334, -9.75F, -36.3F, -8.0F, 2, 0, 16, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 345, 233, -7.0F, -24.0F, 6.6F, 14, 20, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 347, 223, 6.85F, -24.3F, -6.0F, 1, 20, 13, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 347, 223, 7.35F, -2.0F, -7.0F, 0, 1, 14, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 347, 223, -8.45F, -1.7F, -7.0F, 0, 1, 14, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 345, 222, -7.85F, -24.3F, -6.0F, 1, 20, 13, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -6.0F, -32.5F, 7.0F, 12, 1, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -32.8F, -6.0F, 1, 1, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -32.8F, -6.0F, 1, 1, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 428, 260, -6.0F, -31.5F, 6.7F, 12, 6, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 428, 260, 6.95F, -31.8F, -6.0F, 1, 6, 12, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 428, 260, -7.95F, -31.8F, -6.0F, 1, 6, 12, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -0.75F, -31.5F, 7.0F, 2, 28, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -31.8F, -1.25F, 1, 28, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -31.8F, -1.25F, 1, 28, 2, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 345, 233, -0.5F, -33.0F, 7.2F, 1, 32, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, 7.45F, -33.3F, -0.5F, 1, 28, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 345, 233, -8.45F, -33.3F, -0.5F, 1, 32, 1, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -1.25F, -31.5F, 7.0F, 2, 28, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -31.8F, -0.75F, 1, 28, 2, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -31.8F, -0.75F, 1, 28, 2, 0.0F, true));
		box.cubeList.add(new ModelBox(box, 0, 1, -7.0F, -33.0F, 7.0F, 1, 32, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, 7.25F, -33.3F, 6.0F, 1, 32, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 0, 1, -8.25F, -33.3F, 6.0F, 1, 32, 1, 0.0F, true));
		...
		box.addChild(bone16);
		bone16.cubeList.add(new ModelBox(bone16, 24, 312, 0.0354F, -0.3889F, -6.0F, 1, 1, 12, 0.0F, false));
		...
		box.addChild(bone13);
		bone13.cubeList.add(new ModelBox(bone13, 24, 312, -0.1768F, -6.3F, -0.1768F, 1, 6, 1, 0.0F, false));
		...
		rightDoor.cubeList.add(new ModelBox(rightDoor, 379, 77, 1.0F, -23.0F, -0.6F, 6, 6, 1, 0.0F, false));
		...
		leftDoor.cubeList.add(new ModelBox(leftDoor, 100, 357, -6.25F, -17.25F, -1.25F, 1, 1, 1, 0.0F, false));
		leftDoor.cubeList.add(new ModelBox(leftDoor, 244, 299, -6.0F, -21.0F, -1.5F, 0, 2, 1, 0.0F, false));
