...
public class BrachackiBoxCModel extends AbstractTardisExteriorModel {
	...
	public BrachackiBoxCModel() {
		textureWidth = 512;
		textureHeight = 512;

		lamp = new ModelRenderer(this);
		lamp.setRotationPoint(-8.0F, 16.0F, 8.0F);
		lamp.setTextureOffset(428, 260).addBox(7.0F, -33.7F, -9.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

		box = new ModelRenderer(this);
		box.setRotationPoint(0.0F, 24.0F, 0.0F);
		box.setTextureOffset(332, 257).addBox(-9.5F, -1.0F, -9.5F, 19.0F, 1.0F, 19.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.5F, -38.0F, -8.5F, 17.0F, 1.0F, 17.0F, 0.0F, false);
		box.setTextureOffset(148, 293).addBox(-7.5F, -37.1F, -7.5F, 15.0F, 3.0F, 15.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-7.0F, -38.15F, -7.0F, 14.0F, 3.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-8.0F, -38.05F, -8.0F, 16.0F, 1.0F, 16.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-6.5F, -38.2F, -6.5F, 13.0F, 3.0F, 13.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-7.5F, -38.1F, -7.5F, 15.0F, 1.0F, 15.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-6.0F, -38.25F, -6.0F, 12.0F, 3.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-5.5F, -38.3F, -5.5F, 11.0F, 3.0F, 11.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-5.0F, -38.35F, -5.0F, 10.0F, 3.0F, 10.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-4.5F, -38.4F, -4.5F, 9.0F, 3.0F, 9.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-4.0F, -38.45F, -4.0F, 8.0F, 3.0F, 8.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-3.5F, -38.5F, -3.5F, 7.0F, 3.0F, 7.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-2.5F, -38.6F, -2.5F, 5.0F, 3.0F, 5.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-3.0F, -38.55F, -3.0F, 6.0F, 3.0F, 6.0F, 0.0F, false);
		box.setTextureOffset(99, 438).addBox(-1.5F, -38.9F, -1.5F, 3.0F, 3.0F, 3.0F, 0.0F, false);
		box.setTextureOffset(379, 84).addBox(-1.0F, -42.2F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(379, 84).addBox(0.25F, -41.7F, -1.25F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(379, 84).addBox(0.25F, -41.7F, 0.25F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(379, 84).addBox(-1.25F, -41.7F, -1.25F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(379, 84).addBox(-1.25F, -41.7F, 0.25F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(392, 59).addBox(-1.5F, -41.9F, -1.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-2.0F, -38.65F, -2.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(8.0F, -37.0F, -9.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(8.0F, -37.0F, 7.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-8.5F, -37.0F, -9.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(8.0F, -37.0F, -9.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(8.0F, -37.0F, 7.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-8.5F, -37.0F, 7.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, -9.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, 7.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, -9.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.0F, -37.0F, -9.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.5F, -37.0F, -9.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.5F, -37.0F, 7.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, -8.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, 8.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, 8.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.0F, -37.0F, 8.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.5F, -37.0F, -8.5F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.5F, -37.0F, 8.0F, 2.0F, 36.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, -9.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, -9.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, 7.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(7.5F, -37.0F, 7.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, -9.0F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(157, 100).addBox(-9.0F, -37.0F, 7.5F, 1.0F, 36.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(6.0F, -33.0F, 7.0F, 1.0F, 32.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -33.3F, -7.0F, 1.0F, 32.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -33.3F, -7.0F, 1.0F, 32.0F, 1.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -4.0F, 7.0F, 12.0F, 3.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -4.3F, -6.0F, 1.0F, 3.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 6).addBox(7.25F, -4.0F, -7.0F, 1.0F, 3.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -4.3F, -6.0F, 1.0F, 3.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -11.0F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -11.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -11.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -11.5F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -11.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -11.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -18.0F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -18.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -18.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -18.5F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -18.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -18.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -25.0F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -25.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -25.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -25.5F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -25.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -25.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -33.0F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -33.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -33.3F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		...
		box.setTextureOffset(345, 233).addBox(1.0F, -33.7F, -8.45F, 1.0F, 1.0F, 0.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(-2.0F, -33.7F, -8.45F, 1.0F, 1.0F, 0.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(7.45F, -34.3F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(-8.45F, -34.3F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, true);
		...
		box.setTextureOffset(0, 1).addBox(7.65F, -34.6F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.65F, -34.6F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, true);
		...
		box.setTextureOffset(345, 233).addBox(7.85F, -34.9F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(-8.85F, -34.9F, -7.0F, 1.0F, 1.0F, 14.0F, 0.0F, true);
		box.setTextureOffset(321, 334).addBox(-8.0F, -34.0F, 7.75F, 16.0F, 0.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-8.0F, -34.0F, -9.75F, 16.0F, 0.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(7.75F, -34.3F, -8.0F, 2.0F, 0.0F, 16.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-9.75F, -34.3F, -8.0F, 2.0F, 0.0F, 16.0F, 0.0F, true);
		box.setTextureOffset(321, 334).addBox(6.0F, -36.0F, 7.75F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(6.0F, -36.0F, -9.75F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(7.75F, -36.3F, -8.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-9.75F, -36.3F, -8.0F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		box.setTextureOffset(145, 290).addBox(-6.0F, -36.0F, 8.95F, 12.0F, 2.0F, 0.0F, 0.0F, false);
		box.setTextureOffset(145, 290).addBox(-6.0F, -36.0F, -9.2F, 12.0F, 2.0F, 0.0F, 0.0F, false);
		box.setTextureOffset(44, 376).addBox(9.2F, -36.3F, -6.0F, 0.0F, 2.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(44, 376).addBox(-8.95F, -36.3F, -6.0F, 0.0F, 2.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(321, 334).addBox(-8.0F, -36.0F, 7.75F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-8.0F, -36.0F, -9.75F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(7.75F, -36.3F, 6.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-9.75F, -36.3F, 6.0F, 2.0F, 2.0F, 2.0F, 0.0F, true);
		box.setTextureOffset(321, 334).addBox(-8.0F, -36.0F, 7.75F, 16.0F, 0.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-8.0F, -36.0F, -9.75F, 16.0F, 0.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(7.75F, -36.3F, -8.0F, 2.0F, 0.0F, 16.0F, 0.0F, false);
		box.setTextureOffset(321, 334).addBox(-9.75F, -36.3F, -8.0F, 2.0F, 0.0F, 16.0F, 0.0F, true);
		box.setTextureOffset(345, 233).addBox(-7.0F, -24.0F, 6.6F, 14.0F, 20.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(347, 223).addBox(6.85F, -24.3F, -6.0F, 1.0F, 20.0F, 13.0F, 0.0F, false);
		box.setTextureOffset(347, 223).addBox(7.35F, -2.0F, -7.0F, 0.85F, 1.0F, 14.0F, 0.0F, false);
		box.setTextureOffset(347, 223).addBox(-8.45F, -1.7F, -7.0F, 0.85F, 1.0F, 14.0F, 0.0F, true);
		box.setTextureOffset(345, 222).addBox(-7.85F, -24.3F, -6.0F, 1.0F, 20.0F, 13.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-6.0F, -32.5F, 7.0F, 12.0F, 1.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -32.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -32.8F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(428, 260).addBox(-6.0F, -31.5F, 6.7F, 12.0F, 6.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(428, 260).addBox(6.95F, -31.8F, -6.0F, 1.0F, 6.0F, 12.0F, 0.0F, false);
		box.setTextureOffset(428, 260).addBox(-7.95F, -31.8F, -6.0F, 1.0F, 6.0F, 12.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-0.75F, -31.5F, 7.0F, 2.0F, 28.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -31.8F, -1.25F, 1.0F, 28.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -31.8F, -1.25F, 1.0F, 28.0F, 2.0F, 0.0F, true);
		box.setTextureOffset(345, 233).addBox(-0.5F, -33.0F, 7.2F, 1.0F, 32.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(7.45F, -33.3F, -0.5F, 1.0F, 28.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(345, 233).addBox(-8.45F, -33.3F, -0.5F, 1.0F, 32.0F, 1.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-1.25F, -31.5F, 7.0F, 2.0F, 28.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -31.8F, -0.75F, 1.0F, 28.0F, 2.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -31.8F, -0.75F, 1.0F, 28.0F, 2.0F, 0.0F, true);
		box.setTextureOffset(0, 1).addBox(-7.0F, -33.0F, 7.0F, 1.0F, 32.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(7.25F, -33.3F, 6.0F, 1.0F, 32.0F, 1.0F, 0.0F, false);
		box.setTextureOffset(0, 1).addBox(-8.25F, -33.3F, 6.0F, 1.0F, 32.0F, 1.0F, 0.0F, true);
		...
		bone16.setTextureOffset(24, 312).addBox(0.0354F, -0.3889F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		...
		bone13.setTextureOffset(24, 312).addBox(-0.1768F, -6.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);
		...
		bone14.setTextureOffset(24, 312).addBox(-0.1768F, -3.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone15 = new ModelRenderer(this);
		bone15.setRotationPoint(-8.0F, -25.5F, 0.0F);
		box.addChild(bone15);
		setRotationAngle(bone15, 0.0F, 0.0F, -0.7854F);
		bone15.setTextureOffset(24, 312).addBox(0.0354F, -0.3889F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);

		bone19 = new ModelRenderer(this);
		bone19.setRotationPoint(-8.0F, -28.5F, -6.0F);
		box.addChild(bone19);
		setRotationAngle(bone19, 0.0F, 0.7854F, 0.0F);
		bone19.setTextureOffset(24, 312).addBox(-0.1768F, -3.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone17 = new ModelRenderer(this);
		bone17.setRotationPoint(-8.0F, -28.5F, 0.0F);
		box.addChild(bone17);
		setRotationAngle(bone17, 0.0F, 0.0F, -0.7854F);
		bone17.setTextureOffset(24, 312).addBox(0.0354F, -0.3889F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);

		bone18 = new ModelRenderer(this);
		bone18.setRotationPoint(-8.0F, -28.5F, -1.25F);
		box.addChild(bone18);
		setRotationAngle(bone18, 0.0F, 0.7854F, 0.0F);
		bone18.setTextureOffset(24, 312).addBox(-0.1768F, -3.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone21 = new ModelRenderer(this);
		bone21.setRotationPoint(-8.0F, -25.5F, -2.83F);
		box.addChild(bone21);
		setRotationAngle(bone21, 0.0F, 0.7854F, 0.0F);
		bone21.setTextureOffset(24, 312).addBox(-0.1768F, -6.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone20 = new ModelRenderer(this);
		bone20.setRotationPoint(-8.0F, -25.5F, 2.83F);
		box.addChild(bone20);
		setRotationAngle(bone20, 0.0F, 0.7854F, 0.0F);
		bone20.setTextureOffset(24, 312).addBox(-0.1768F, -6.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone23 = new ModelRenderer(this);
		bone23.setRotationPoint(8.0F, -25.5F, 6.0F);
		box.addChild(bone23);
		setRotationAngle(bone23, 0.0F, 0.7854F, 0.0F);
		bone23.setTextureOffset(24, 312).addBox(-0.8232F, -6.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone24 = new ModelRenderer(this);
		bone24.setRotationPoint(8.0F, -28.5F, 1.25F);
		box.addChild(bone24);
		setRotationAngle(bone24, 0.0F, 0.7854F, 0.0F);
		bone24.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone22 = new ModelRenderer(this);
		bone22.setRotationPoint(-8.0F, -25.5F, -4.41F);
		box.addChild(bone22);
		setRotationAngle(bone22, 0.0F, 0.7854F, 0.0F);
		bone22.setTextureOffset(24, 312).addBox(-0.1768F, -6.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone25 = new ModelRenderer(this);
		bone25.setRotationPoint(8.0F, -28.5F, -1.25F);
		box.addChild(bone25);
		setRotationAngle(bone25, 0.0F, 0.7854F, 0.0F);
		bone25.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone27 = new ModelRenderer(this);
		bone27.setRotationPoint(8.0F, -28.5F, 2.83F);
		box.addChild(bone27);
		setRotationAngle(bone27, 0.0F, 0.7854F, 0.0F);
		bone27.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone26 = new ModelRenderer(this);
		bone26.setRotationPoint(8.0F, -28.5F, -6.0F);
		box.addChild(bone26);
		setRotationAngle(bone26, 0.0F, 0.7854F, 0.0F);
		bone26.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone28 = new ModelRenderer(this);
		bone28.setRotationPoint(8.0F, -28.5F, -2.83F);
		box.addChild(bone28);
		setRotationAngle(bone28, 0.0F, 0.7854F, 0.0F);
		bone28.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone29 = new ModelRenderer(this);
		bone29.setRotationPoint(8.0F, -28.5F, -4.41F);
		box.addChild(bone29);
		setRotationAngle(bone29, 0.0F, 0.7854F, 0.0F);
		bone29.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone30 = new ModelRenderer(this);
		bone30.setRotationPoint(8.0F, -28.5F, 4.41F);
		box.addChild(bone30);
		setRotationAngle(bone30, 0.0F, 0.7854F, 0.0F);
		bone30.setTextureOffset(24, 312).addBox(-0.8232F, -3.3F, -0.8232F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone31 = new ModelRenderer(this);
		bone31.setRotationPoint(-8.0F, -25.5F, 4.41F);
		box.addChild(bone31);
		setRotationAngle(bone31, 0.0F, 0.7854F, 0.0F);
		bone31.setTextureOffset(24, 312).addBox(-0.1768F, -6.3F, -0.1768F, 1.0F, 6.0F, 1.0F, 0.0F, false);

		bone32 = new ModelRenderer(this);
		bone32.setRotationPoint(8.0F, -25.5F, 0.0F);
		box.addChild(bone32);
		setRotationAngle(bone32, 0.0F, 0.0F, -0.7854F);
		bone32.setTextureOffset(24, 312).addBox(-0.6111F, -1.0354F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);

		bone33 = new ModelRenderer(this);
		bone33.setRotationPoint(8.0F, -28.5F, 0.0F);
		box.addChild(bone33);
		setRotationAngle(bone33, 0.0F, 0.0F, -0.7854F);
		bone33.setTextureOffset(24, 312).addBox(-0.6111F, -1.0354F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);

		bone34 = new ModelRenderer(this);
		bone34.setRotationPoint(8.0F, -31.5F, 0.0F);
		box.addChild(bone34);
		setRotationAngle(bone34, 0.0F, 0.0F, -0.7854F);
		bone34.setTextureOffset(24, 312).addBox(-0.6111F, -1.0354F, -6.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);
		...
		rightDoor.setTextureOffset(379, 77).addBox(1.0F, -23.0F, -0.6F, 6.0F, 6.0F, 1.0F, 0.0F, false);
		...
		leftDoor.setTextureOffset(100, 357).addBox(-6.25F, -17.25F, -1.25F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		leftDoor.setTextureOffset(244, 299).addBox(-6.0F, -21.0F, -1.5F, 0.0F, 2.0F, 1.0F, 0.0F, false);
