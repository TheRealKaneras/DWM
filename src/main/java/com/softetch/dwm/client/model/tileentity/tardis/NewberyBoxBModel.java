...
public class NewberyBoxBModel extends AbstractTardisExteriorModel {
	...
	public NewberyBoxBModel() {
		...
		lamp.cubeList.add(new ModelBox(lamp, 161, 164, -0.5F, -43.0F, -0.5F, 1, 3, 1, 0.0F, false));
		...
		box.cubeList.add(new ModelBox(box, 305, 234, 0.5F, -43.0F, 0.5F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 305, 234, -1.5F, -43.5F, -1.5F, 3, 1, 3, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 305, 234, -1.5F, -43.0F, 0.5F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 305, 234, 0.5F, -43.0F, -1.5F, 1, 3, 1, 0.0F, false));
		box.cubeList.add(new ModelBox(box, 305, 234, -1.5F, -43.0F, -1.5F, 1, 3, 1, 0.0F, false));
