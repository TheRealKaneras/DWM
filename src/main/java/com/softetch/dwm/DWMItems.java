...
public class DWMItems {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event){
        ...
        event.getRegistry().registerAll(
                ...
                addBlock(new RoundelBlock(false), "oak_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "spruce_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "birch_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "jungle_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "acacia_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "dark_oak_roundel", ItemGroup.DECORATIONS),

                addBlock(new RoundelBlock(false), "stripped_oak_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "stripped_spruce_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "stripped_birch_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "stripped_jungle_roundel", ItemGroup.DECORATIONS),
                ...
                addBlock(new RoundelBlock(false), "iron_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "gold_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "diamond_roundel", ItemGroup.DECORATIONS),
                addBlock(new RoundelBlock(false), "lapis_roundel", ItemGroup.DECORATIONS),
